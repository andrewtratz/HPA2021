...
from networks.efficientnet import class_efficientnet_b0, class_efficientnet_b4
...
model_names = {
    ...
    'class_efficientnet_b0': 'efficientnet-b0-08094119.pth',
    'class_efficientnet_b4': 'efficientnet-b4-e116e8b3.pth'
}
...
def init_network(params):
    ...
    pretrain = params.get('pretrain', True) # WAS True
